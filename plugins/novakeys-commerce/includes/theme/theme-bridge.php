            ...
            'sections' => [
                ...
                [
                    ...
                    'body'      => [
                        ...
                        '<strong>Tax invoices.</strong> A tax invoice (فاتورة ضريبية) showing the VAT breakdown is issued for every paid order, in line with KSA tax-authority (ZATCA) requirements.',
                        ...
                        '<div dir="rtl" lang="ar"><strong>الفاتورة الضريبية.</strong> تصدر فاتورة ضريبية تتضمّن بيان ضريبة القيمة المضافة عن كل طلب مدفوع، وفق متطلبات هيئة الزكاة والضريبة والجمارك (ZATCA).</div>',
                    ],
                ],
                [
                    'kicker_en' => '04 · IP',
            ...
            'sections' => [
                ...
                [
                    ...
                    'body'      => [
                        ...
                        '<strong>Tax authority</strong> — ZATCA receives the tax invoice for every paid order in line with KSA e-invoicing requirements.',
                        ...
                        '<div dir="rtl" lang="ar"><strong>الجهة الضريبية</strong> — تستلم ZATCA الفاتورة الضريبية لكل طلب مدفوع وفق متطلبات الفوترة الإلكترونية في المملكة.</div>',
